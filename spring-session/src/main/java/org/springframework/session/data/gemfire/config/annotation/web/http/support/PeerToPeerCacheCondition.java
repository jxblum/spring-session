...
/**
 * The PeerToPeerCacheCondition class is a Spring Condition type used with @Conditional annotated bean definitions
 * to indicate that the annotated bean will only be created if there exists a GemFire cache instance of type
 * {@link com.gemstone.gemfire.cache.Cache} in the Spring context.
 *
 * @author John Blum
 ...
 * @since 1.1.0
 */
public class PeerToPeerCacheCondition extends AbstractCacheCondition {

	/**
	 * Returns a type representative of a GemFire peer cache.
	 *
	 * @return GemFire peer cache type representation.
	 */
	@Override
